...
import type { Navigation_Links_Properties } from "./Types";

export function Navigation_Links({ Nav_Links, Support_Links, On_Link_Click }: Navigation_Links_Properties) {
  return (
      ...
      <div>
        ...
        <div className="space-y-1">
          {Nav_Links.map((link) => (
            <button
              key={link.path}
              onClick={() => On_Link_Click(link.path)}
