...
interface State {
  hasError: boolean;
  error: Error | null; // Changed 'error' to 'Error'
}
...
export class ErrorBoundary extends Component<Properties, State> {
  ...
  public static getDerivedStateFromError(error: Error): State { // Changed 'error' to 'Error'
    return { hasError: true, error };
  }

  public componentDidCatch(error: Error, errorInfo: ErrorInfo) { // Changed 'error' to 'Error'
