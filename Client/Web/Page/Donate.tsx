...
export default function Donate() {
  ...
  const [Frequency, Set_Frequency] = useState<Frequency>("monthly");
              ...
              <div className="space-y-4 animate-in fade-in Duration-150">
                <div className="flex justify-center">
                  <SlidingPill
                    size="md"
                    value={Mode}
                    On_Change={(v) => setMode(v as "once" | "recurring")}
                    options={[
                ...
                {Mode === "recurring" && (
                  <div className="flex justify-center">
                    <SlidingPill
                      size="sm"
                      value={Frequency}
                      On_Change={(v) => Set_Frequency(v as Frequency)}
                      options={[
                ...
                <div className="flex items-stretch gap-2">
                  <Dropdown_Menu>
                    ...
                    <Dropdown_Menu_Content align="start" className="max-h-[240px] overflow-y-auto">
                      {CURRENCIES.map((c) => (
                        <Dropdown_Menu_Item 
                          key={c.value} 
