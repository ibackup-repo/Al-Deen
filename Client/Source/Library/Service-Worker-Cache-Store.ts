...
const AID_CACHE_NAME = "Aid-Data-Cache-V1";
...
export const Get_Saved_Aid_Dua_Categories = <T>(Key: string = "All"): Promise<T | null> =>
  Read_Cached_JSON<T>(AID_CACHE_NAME, "Dua-Categories", Key);

export const Save_Aid_Dua_Categories_Locally = (Data: unknown, Key: string = "All"): Promise<void> =>
  Write_Cached_JSON(AID_CACHE_NAME, "Dua-Categories", Key, Data);

export const Get_Saved_Aid_Dua_Category = <T>(Key: string): Promise<T | null> =>
  Read_Cached_JSON<T>(AID_CACHE_NAME, "Dua-Category", Key);

export const Save_Aid_Dua_Category_Locally = (Key: string, Data: unknown): Promise<void> =>
  Write_Cached_JSON(AID_CACHE_NAME, "Dua-Category", Key, Data);

export const Get_Saved_Aid_Article_Topics = <T>(Key: string = "All"): Promise<T | null> =>
  Read_Cached_JSON<T>(AID_CACHE_NAME, "Article-Topics", Key);

export const Save_Aid_Article_Topics_Locally = (Data: unknown, Key: string = "All"): Promise<void> =>
  Write_Cached_JSON(AID_CACHE_NAME, "Article-Topics", Key, Data);

export const Get_Saved_Aid_Article_Topic = <T>(Topic_ID: number): Promise<T | null> =>
  Read_Cached_JSON<T>(AID_CACHE_NAME, "Article-Topic", Topic_ID);

export const Save_Aid_Article_Topic_Locally = (Topic_ID: number, Data: unknown): Promise<void> =>
  Write_Cached_JSON(AID_CACHE_NAME, "Article-Topic", Topic_ID, Data);

export const Get_Saved_Aid_Names = <T>(Key: string = "All"): Promise<T | null> =>
  Read_Cached_JSON<T>(AID_CACHE_NAME, "Names", Key);

export const Save_Aid_Names_Locally = (Data: unknown, Key: string = "All"): Promise<void> =>
  Write_Cached_JSON(AID_CACHE_NAME, "Names", Key, Data);

export const Get_Saved_Aid_Pillars = <T>(Key: string = "All"): Promise<T | null> =>
  Read_Cached_JSON<T>(AID_CACHE_NAME, "Pillars", Key);

export const Save_Aid_Pillars_Locally = (Data: unknown, Key: string = "All"): Promise<void> =>
  Write_Cached_JSON(AID_CACHE_NAME, "Pillars", Key, Data);

export const Get_Saved_Aid_Prophets = <T>(Key: string = "All"): Promise<T | null> =>
  Read_Cached_JSON<T>(AID_CACHE_NAME, "Prophets", Key);

export const Save_Aid_Prophets_Locally = (Data: unknown, Key: string = "All"): Promise<void> =>
  Write_Cached_JSON(AID_CACHE_NAME, "Prophets", Key, Data);

export const Get_Saved_Aid_Schools = <T>(Key: string = "All"): Promise<T | null> =>
  Read_Cached_JSON<T>(AID_CACHE_NAME, "Schools", Key);

export const Save_Aid_Schools_Locally = (Data: unknown, Key: string = "All"): Promise<void> =>
  Write_Cached_JSON(AID_CACHE_NAME, "Schools", Key, Data);

export const Clear_Aid_Cache = (): Promise<boolean> => caches.delete(AID_CACHE_NAME);

export const Build_Aid_Dua_Category_Key = (Category_ID: number, Include_WBW: boolean): string =>
  `Category::${Category_ID}::wbw=${Include_WBW}`;