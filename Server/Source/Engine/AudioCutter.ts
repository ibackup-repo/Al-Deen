// Cuts an arbitrary [Start_Milliseconds, End_Milliseconds) Range out of an audio file with ffmpeg.
...
export function cutAudioFile(
  ...
  // MP3 frame (~26ms) — audible/visible against Kalimah-Level highlight timing
